 ...
 */
function activateNotebookTools(app, tracker, editorServices, state, labShell, inspectorProvider) {
 ...
 */
function activateNotebookHandler(app, contentFactory, docManager, editorServices, rendermime, palette, browserFactory, launcher, restorer, mainMenu, settingRegistry, sessionDialogs) {
    const services = app.serviceManager;
    ...
    function updateConfig(settings) {
        let code = Object.assign(Object.assign({}, StaticNotebook.defaultEditorConfig.code), settings.get('codeCellConfig').composite);
        let markdown = Object.assign(Object.assign({}, StaticNotebook.defaultEditorConfig.markdown), settings.get('markdownCellConfig').composite);
        let raw = Object.assign(Object.assign({}, StaticNotebook.defaultEditorConfig.raw), settings.get('rawCellConfig').composite);
...
function addCommands(app, docManager, services, tracker, clonedOutputs, sessionDialogs) {
    ...
    commands.addCommand(CommandIDs.runInConsole, {
        ...
        execute: async (args) => {
            ...
            let metadata = (_a = cell) === null || _a === void 0 ? void 0 : _a.model.metadata.toJSON();
            ...
            if (selected) {
                ...
                while (true) {
                    ...
                    let reply = await ((_c = (_b = current.context.sessionContext.session) === null || _b === void 0 ? void 0 : _b.kernel) === null || _c === void 0 ? void 0 : _c.requestIsComplete({
...
function populateMenus(app, mainMenu, tracker, services, palette, sessionDialogs) {
    ...
    mainMenu.kernelMenu.kernelUsers.add({
        ...
        interruptKernel: current => {
            var _a;
            let kernel = (_a = current.sessionContext.session) === null || _a === void 0 ? void 0 : _a.kernel;
            if (kernel) {
                return kernel.interrupt();
            }
