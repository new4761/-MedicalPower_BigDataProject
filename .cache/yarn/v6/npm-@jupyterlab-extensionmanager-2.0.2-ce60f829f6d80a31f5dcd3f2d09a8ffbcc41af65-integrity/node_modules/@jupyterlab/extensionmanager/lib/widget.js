...
import { Button, caretDownIcon, caretRightIcon, Collapse, InputGroup, jupyterIcon, refreshIcon } from '@jupyterlab/ui-components';
...
function ListEntry(props) {
    ...
    return (React.createElement("li", { className: `jp-extensionmanager-entry ${flagClasses.join(' ')}`, title: title },
        React.createElement("div", { className: "jp-extensionmanager-entry-title" },
            ...
            React.createElement(jupyterIcon.react, { className: "jp-extensionmanager-entry-jupyter-org", top: "1px", height: "auto", width: "1em" })),
    ...
    render() {
        return (React.createElement(React.Fragment, null,
            React.createElement("header", null,
                React.createElement(ToolbarButtonComponent, { icon: this.state.isOpen ? caretDownIconStyled : caretRightIconStyled, onClick: () => {
                        this.handleCollapse();
                    } }),
...
export class ExtensionView extends VDomRenderer {
    ...
    render() {
        ...
        if (!model.initialized) {
            ...
            content.push(React.createElement(CollapsibleSection, { key: "installed-section", isOpen: true, header: "Installed", headerElements: React.createElement(ToolbarButtonComponent, { key: "refresh-button", icon: refreshIcon, onClick: () => {
